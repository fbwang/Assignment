(function() {
    ...
    ,
    K.xj = function() {
        if (K.R(K.global.ye) && K.L(K.global.ye))
            K.La = K.global.ye;
        else if (K.qg()) {
            var b = K.global.document
              , c = b.currentScript;
    ...
    K.Tl = function(b, c) {
        if (K.qg()) {
            ...
            void 0 === c ? K.di ? (K.$g = !0,
            c = " onreadystatechange='goog.onScriptLoad_(this, " + ++K.Pg + ")' ",
            d.write(n + b + '"' + c + ">\x3c/script>")) : K.De ? K.Ki(b) : K.Sl(b) : d.write('<script type="text/javascript">' + K.Tk(c) + "\x3c/script>");
            return !0
        }
        return !1
    }
    ...
    K.f.ta = function(b, c) {
        if (c)
            b = b.replace(K.f.ke, "&amp;").replace(K.f.Je, "&lt;").replace(K.f.Ge, "&gt;").replace(K.f.Qe, "&quot;").replace(K.f.Te, "&#39;").replace(K.f.Le, "&#0;"),
    ...
    K.j.Ib = function(b, c, d) {
        if (!K.Nb(b) || !K.Nb(c) || b.length != c.length)
            return !1;
        var e = b.length;
        d = d || K.j.lj;
        for (var f = 0; f < e; f++)
    ...
    K.h.i.yf = function(b, c) {
        ...
        for (c = 0; c < b.length; c++) {
            var g = b[c];
            K.h.i.nh(g) ? (d++,
            e++) : K.h.i.Jg.test(g) ? f = !0 : K.h.i.og(g) ? e++ : K.h.i.Xj.test(g) && (f = !0)
        }
    ...
    K.g.userAgent.v.Lb = function() {
        ...
        if (K.g.userAgent.v.uc())
            return K.g.userAgent.v.Jj(c);
    ...
    K.g.userAgent.U.Lb = function() {
        ...
        if (b) {
            ...
            if (c)
                return "Gecko" == c[0] ? K.g.userAgent.U.Rj(b) : c[1];
            b = b[0];
            var d;
    ...
    K.async.pa = function(b, c, d) {
        ...
        c && (e = K.bind(b, c));
        e = K.async.pa.Ah(e);
        K.ya(K.global.setImmediate) && (d || K.async.pa.Kl()) ? K.global.setImmediate(e) : (K.async.pa.kh || (K.async.pa.kh = K.async.pa.Nj()),
        K.async.pa.kh(e))
    }
    ;
    ...
    K.g.userAgent.platform.Lb = function() {
        var b = K.g.userAgent.A.sb()
          , c = "";
        K.g.userAgent.platform.Og() ? (c = /Windows (?:NT|Phone) ([0-9.]+)/,
        c = (b = c.exec(b)) ? b[1] : "0.0") : K.g.userAgent.platform.Eg() ? (c = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/,
        c = (b = c.exec(b)) && b[1].replace(/_/g, ".")) : K.g.userAgent.platform.Ig() ? (c = /Mac OS X ([0-9_.]+)/,
        c = (b = c.exec(b)) ? b[1].replace(/_/g, ".") : "10") : K.g.userAgent.platform.yg() ? (c = /Android\s+([^\);]+)(\)|;)/,
        c = (b = c.exec(b)) && b[1]) : K.g.userAgent.platform.Ag() && (c = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/,
        c = (b = c.exec(b)) && b[1]);
        return c || ""
    }
    ;
    ...
    K.userAgent.oj = function() {
        var b = ""
          , c = K.userAgent.Sj();
        c && (b = c ? c[1] : "");
        return K.userAgent.Y && (c = K.userAgent.Of(),
    ...
    K.b.B.create = function(b) {
        ...
        for (d in b) {
            ...
            var e = b[d];
            null != e && (e = K.isArray(e) ? K.j.map(e, K.b.B.gh).join(" ") : K.b.B.gh(e),
            c += d + ":" + e + ";")
        }
    ...
    K.b.B.il = function(b) {
        ...
        return K.b.B.Ei.test(c) ? K.b.B.Vj(b) ? K.b.B.jl(b) : (K.m.ma("String value requires balanced quotes, got: " + b),
        K.b.B.Ka) : (K.m.ma("String value allows only " + K.b.B.$e + " and simple functions, got: " + b),
        K.b.B.Ka)
    }
    ;
    K.b.B.Vj = function(b) {
    ...
    K.b.l.Cj = function(b, c, d) {
        if (d instanceof K.f.I)
            ...
            if (c.toLowerCase()in K.b.l.Ci)
                if (d instanceof K.b.C)
                    d = K.b.C.u(d);
                else if (d instanceof K.b.o)
                    d = K.b.o.u(d);
                else if (K.L(d))
                    d = K.b.o.Gc(d).ga();
                else
    ...
    K.b.l.concat = function(b) {
        function c(b) {
            K.isArray(b) ? K.j.forEach(b, c) : (b = K.b.l.ta(b),
            e += K.b.l.u(b),
            b = b.$a(),
    ...
    K.b.l.Ya = function(b, c, d) {
        ...
        K.a.Mc.sk(b.toLowerCase()) ? f += ">" : (e = K.b.l.concat(d),
        f += ">" + K.b.l.u(e) + "</" + b + ">",
        e = e.$a());
    ...
    K.a.nc = function(b, c, d, e) {
        ...
        if (d) {
            ...
            for (g = f = 0; h = b[g]; g++)
                c = h.className,
                typeof c.split == u && K.j.contains(c.split(/\s+/), d) && (e[f++] = h);
            e.length = f;
            return e
        }
        return b
    ...
    K.a.fh = function(b, c) {
        var d = K.a.Oa(b, "DIV");
        K.a.ib.ci ? (K.a.S.lh(d, K.b.l.concat(K.b.l.we, c)),
        d.removeChild(d.firstChild)) : K.a.S.lh(d, c);
        return K.a.$i(b, d)
    }
    ;
    K.a.$i = function(b, c) {
    ...
    K.a.eg = function(b) {
        var c;
        if (K.a.ib.Nh && !(K.userAgent.Y && K.userAgent.va("9") && !K.userAgent.va("10") && K.global.SVGElement && b instanceof K.global.SVGElement) && (c = b.parentElement))
            return c;
        c = b.parentNode;
    ...
    K.a.mf = function(b, c) {
        ...
        if (K.userAgent.Y && !K.userAgent.Pb(9)) {
            if (b.nodeType == K.a.fa.Xc)
                return -1;
            if (c.nodeType == K.a.fa.Xc)
                return 1
        }
    ...
    K.a.Ad = function(b, c, d) {
        if (!(b.nodeName in K.a.Ue))
            ...
            else if (b.nodeName in K.a.ac)
                c.push(K.a.ac[b.nodeName]);
            else
                for (b = b.firstChild; b; )
                    K.a.Ad(b, c, d),
                    b = b.nextSibling
    ...
    K.a.ag = function(b, c, d) {
        ...
        for (var e = 0, f = null; 0 < b.length && e < c; )
            if (f = b.pop(),
            !(f.nodeName in K.a.Ue))
                if (f.nodeType == K.a.fa.cc) {
                    var g = f.nodeValue.replace(/(\r\n|\r|\n)/g, "").replace(/ +/g, " ");
                    e += g.length
                } else if (f.nodeName in K.a.ac)
                    e += K.a.ac[f.nodeName].length;
                else
                    for (g = f.childNodes.length - 1; 0 <= g; g--)
                        b.push(f.childNodes[g]);
        K.ha(d) && (d.Is = f ? f.nodeValue.length + c - e - 1 : 0,
        d.node = f);
        return f
    }
    ;
        ...
        return new K.Promise(function(c) {
            ...
            if (d)
                for (var f = function(b, f, g) {
                    ...
                    h = b[g],
                    K.Promise.Ec(h, K.fb(f, g, !0), K.fb(f, g, !1));
            else
                c(e)
        }
        )
    ...
    function P(b, c) {
        if (b.$ == K.Promise.P.wa)
            if (b.da) {
                var d = b.da;
                if (d.Na) {
                    for (var e = 0, f = null, g = null, h = d.Na; h && (h.dc || (e++,
                    h.Xa == b && (f = h),
                    !(f && 1 < e))); h = h.next)
                        f || (g = h);
                    f && (d.$ == K.Promise.P.wa && 1 == e ? P(d, c) : (g ? (e = g,
                    e.next == d.ob && (d.ob = e),
    ...
    ;
    function O(b, c, d) {
        b.$ == K.Promise.P.wa && (b === d && (c = K.Promise.P.ka,
        d = new TypeError("Promise cannot resolve to itself")),
        b.$ = K.Promise.P.Jh,
        K.Promise.Ug(d, b.Dl, b.El, b) || (b.ia = d,
        b.$ = c,
        b.da = null,
        T(b),
        c != K.Promise.P.ka || d instanceof K.Promise.kb || K.Promise.Ii(b, d)))
    }
    ...
    K.Promise.Ii = function(b, c) {
        ...
        }, K.Promise.Wa) : 0 == K.Promise.Wa && (b.rc = !0,
        K.async.M(function() {
            b.rc && (U(b, c),
            K.Promise.sc.call(null, c))
        }))
...
*/
    ...
    function W(b) {
        b.Nc && b.qb && fa(b) && (K.async.w.Il(b.Nc),
        b.Nc = 0);
        b.da && (b.da.ec--,
        delete b.da);
        for (var c = b.ia, d = !1, e = !1; b.Ic.length && !b.bd; ) {
            ...
            if (g = b.ub ? h : g)
                try {
                    ...
                    K.R(l) && (b.ub = b.ub && (l == c || l instanceof Error),
                    b.ia = c = l);
                    if (K.Thenable.Dg(c) || typeof K.global.Promise === u && c instanceof K.global.Promise)
                        e = !0,
                        b.bd = !0
                } catch (m) {
                    c = m,
    ...
    K.async.w.Il = function(b) {
        ...
        c && (K.global.clearTimeout(c.Mb),
        delete K.async.w.Jb[b])
    }
    ;
    ...
    K.D.F.Fc = function(b, c) {
        ...
        f.onload = f.onreadystatechange = function() {
            f.readyState && "loaded" != f.readyState && f.readyState != t || (K.D.F.gc(f, d.Xp || !1, l),
            h.Db(null))
        }
        ;
        f.onerror = function() {
    ...
    K.D.F.Ws = function(b, c, d) {
        ...
        var e = K.global[K.D.F.Zc]
          , f = K.b.C.u(b);
        if (K.R(e[c]))
            return K.async.w.ma(new K.D.F.Error(K.D.F.Yb.Gi,"Verification object " + c + " already defined."));
        b = K.D.F.Fc(b, d);
        var g = new K.async.w(K.bind(b.cancel, b));
        Y(b, function() {
            var b = e[c];
            K.R(b) ? (g.Db(b),
            delete e[c]) : g.Za(new K.D.F.Error(K.D.F.Yb.Fi,"Script " + f + " loaded, but verification object " + c + " was not defined."))
        });
        ea(b, function(b) {
            K.R(e[c]) && delete e[c];
            g.Za(b)
    ...
    google.G.H.T.Bk = function(b) {
        var c = google.G.H.T.Kk(b)
          , d = K.f.I.from("/GoogleCharts/charts/%{version}/loader.js");
